...
class Stock_Time_Series():
    ...
    def fetch_data(self, symbol_list):
        ...
        if 'SPY' not in symbol_list:
            ...
            print("ddddddddddddddddddddddddddddddddddddddd0")
        ...
        try:            
            ...
            print("ddddddddddddddddddddddddddddddddddddddd2")
        ...
        for symbol in symbol_list:
            try:
                ...
                if symbol == 'SPY':
                    print("ddddddddddddddddddddddddddddddddddddddd3")
                    continue
                print("ddddddddddddddddddddddddddddddddddddddd4")
                ...
                # print(e)
                print("ddddddddddddddddddddddddddddddddddddddd6")
                bad_symbols.append(symbol)

        df = df.dropna(subset=['SPY'])
        df.fillna(method='ffill', inplace=True)
        df.fillna(method='bfill', inplace=True)
        print("ddddddddddddddddddddddddddddddddddddddd7")    
    ...
    def __fetch_data(self, symbol):
        ...
        yf.pdr_override()
        fetched_data = pdr.get_data_yahoo(symbol, self.dates[0], self.dates[-1])
